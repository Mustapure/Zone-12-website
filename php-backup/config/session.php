...
function getCurrentUserRole() {
    return isset($_SESSION[SESSION_USER_ROLE]) ? $_SESSION[SESSION_USER_ROLE] : null;
}
 ...
 */
function createUserSession($userId, $email, $name, $userType, $userRole = 'user') {
    ...
    $_SESSION[SESSION_USER_ROLE] = $userRole;
